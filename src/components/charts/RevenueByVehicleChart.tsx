  ...
  if (!data || data.length === 0) {
    return (
      <Card className="h-96 flex flex-col">
        <div className="mb-4">
          <p className="text-[10px] font-bold uppercase tracking-[0.15em] text-textMuted mb-1">Revenue</p>
          <h3 className="text-base font-semibold text-textPrimary">By Vehicle Type</h3>
        </div>
